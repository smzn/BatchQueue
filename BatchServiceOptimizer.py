...
class OptimizeBatchService:
    def __init__(self, lambda_rate, mu, b, m, sim_time, c, d, k1, k2):
    ...
    def objective_function(self, a):
        ...
        avg_queue_length, _, _, _, _ = simulation.calculate_metrics()
    ...
    def optimize(self):
        ...
        res = minimize_scalar(self.objective_function, bounds=(0, self.b), method='bounded')
        optimal_a = res.x
        ...
        initial_value = self.objective_function(initial_a)
        initial_waiting_time = initial_value - (self.k1 * initial_a + self.k2 * (initial_a ** 2))
...
if __name__ == '__main__':
    ...
    optimizer = OptimizeBatchService(lambda_rate, mu, b, m, sim_time, c, d, k1, k2)
